...
public class LikenessBuckets {
	...
	public LikenessBuckets(double b_param, int tuples, int dims, short[][] map,
		...
		//buckNum=tuples;
		this.threshold = th;
		this.inFile = inputFile.substring(inputFile.lastIndexOf('/')+1,
	...
	public short[][][] bucketization(int SA){
		...
		int maxC = maxFreq; //tuples; // maxFreq; //It is <=n. <<=========== NOTE: I CHANGED 'maxFreq' TO 'tuples' (WICH IS 'n', i.e., the DB size). This is only to check what happens for VERY LARGE BETA values!!!! 08/july/2019
		// minimun c is GCD:
