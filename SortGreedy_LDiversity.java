...
public class SortGreedy_LDiversity {
	...
	public static void main(String[] args) 	{
		...
		FileWriter fw = null;
		try{
			fw = new FileWriter("./LDiv_SortGreedy.txt",true); //true == append
		...
		if (q==true){
			...
			try{
				...
				qw = new FileWriter("./LDiv_SortGreedy_QueryError.txt",true); //true == append
