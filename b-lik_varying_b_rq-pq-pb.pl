...
for $i (0 .. $#tuples) {
	for $j (0 .. $#l){
		for $k (0 .. $#d){
			system("$Pcommand $input[$i] $tuples[$i] 7 $l[$j] $tuples[$i] 2 true true true");
                        system("$Pcommand1 $input[$i] $tuples[$i] 7 $l[$j] $tuples[$i] 2 true true true");
                        system("$Pcommand2 $input[$i] $tuples[$i] 7 $l[$j] $tuples[$i] 2 true true true");
